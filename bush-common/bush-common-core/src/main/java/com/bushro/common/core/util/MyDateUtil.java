...
public class MyDateUtil {
     ...
     * 计算两时间分钟差
     *
     * @param startTimeStr 开始时间 ex: 2022-09-09 10:00:10
     * @param endTimeStr   结束时间 ex: 2022-09-09 10:30:10
     * @return 分钟差 ex:30
     * @author luo.qiang
     * @date 2021/9/9 10:21
     */
    ...
    public static void main(String[] args) {
        ...
        boolean result = verifyTime("2022-08-18 00:00:00", "2022-08-17 23:59:59", DATE_TIME_FORMAT);
        ...
        Date date = strToDateTime("2022-08-18 00:00:10");

        Long aLong = strToLong("2022-08-18 00:00:10", DATE_TIME_FORMAT);

        Date dateTimeStartFormat = dateToStartTime(nowDateTime);
        Date dateTimeEndFormat = dateToEndTime(nowDateTime);

        int diffMinute = diffMinute("2022-09-09 10:00:10", "2022-09-09 10:30:10");
